# -*- coding: utf-8 -*-
"""
Created on Sun Jun 10 14:53:02 2018
...
# Se resuelve el sistema usando un algoritmo del módulo BICGSTAB
ZZZ = spla.bicgstab(A.mat(),Su[1:-1])
...
#IMPRESION DEL TIEMPO QUE TARDO EN REALIZAR LA SOLUCION
t2 = time.time()
print("Tiempo Realizado con BICGSTAB de la libreria de Python en 50 Nodos")
...
plt.grid()
plt.legend()
plt.savefig('solucion_BICGSTAB.png')
plt.show()
