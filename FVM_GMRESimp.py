...
# Se resuelve el sistema usando un algoritmo del módulo GMRES
#Vector inicial
x0 = np.zeros(N-1)
#Tolerancia para el metodo
e = 0
#Numero de iteraciones en el Metodo GMRES
nmax_iter = N
#Solucion con el Metodo de BICGSTAB
ZZZZ = GMRES_BICGSTABLibraryImp.GMRes(A.mat(), Su[1:-1], x0, e, nmax_iter)
...
t2 = time.time()
print("Tiempo Realizado con GMRES implementado de Python en 50 Nodos")
...
plt.grid()
plt.legend()
plt.savefig('Resolucion_GMRESimplementado.png')
plt.show()
