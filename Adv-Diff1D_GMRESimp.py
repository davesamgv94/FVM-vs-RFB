# -*- coding: utf-8 -*-
"""
Created on Mon Jun 11 12:54:26 2018
...
#Libreria de GMRES y BICGSTAB implementada
...
#Numero de iteraciones para la parte de algoritmo de implementacion BICGSTAB
max_iter = 500
vel = 0.1 #m/s
...
print(G)
#Solucion con el metodo de GMRES implementado
#Vector inicial
x0 = np.zeros(N-1)
...
nmax_iter = N
#Solucion con el metodo de GMRES implementado
lam = GMRES_BICGSTABLibraryImp.GMRes(G,u, x0, e, nmax_iter)
#Solucion final ya con RBF
u = RBF.evaluate(linea, lam[N], rbf,kernel)
...
t2 = time.time()
print("Tiempo Realizado con GMRES implementado en 50 Nodos")
