...
print(G)
#Solucion con el metodo de BICGSTAB implementado
...
nmax_iter = N
#Solucion con el metodo de BICGSTAB implementado
lam = GMRES_BICGSTABLibraryImp.bicgstab(G,u, x0, e, nmax_iter)
...
print("Tiempo Realizado con BICGSTAB Implementado en 50 Nodos")
